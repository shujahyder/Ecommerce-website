  ...
  return (
    <footer className='border-t py-12'>
     <div className='container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-4 lg:px-0'>
        <div>
            ...
            <p className='text-gray-500 mb-4'>
                Be the first to hear about new products, exclusive offers and latest events.
            </p>
        ...
        <div>
         ...
         <div >
            ...
            <div className='flex items-center space-x-4 mb-6  '>
                ...
                <a href="https://x.com/?lang=en" target='_blank' rel='noopener noreferrer' className='hover:text-gray-500' 
                >
     ...
     <div className="container mx-auto mt-12 px-4 lg:px-0 border-t border-gray-200 pt-6">
        <p className='text-gray-500 text-sm tracking-tighter text-center'>© 2021 Ecommerce. All Rights Reserved.</p>
     </div>
    </footer>
  )
}
